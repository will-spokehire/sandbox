...
--
-- Create payload schema for Payload CMS
--
...
-- Grant usage on payload schema to roles
...
CREATE TYPE "public"."DealVehicleStatus" AS ENUM (
    'ACTIVE',
    'REMOVED',
    'WINNER'
);
...
ALTER TYPE "public"."DealVehicleStatus" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."calculate_distance_miles"("lat1" double precision, "lon1" double precision, "lat2" double precision, "lon2" double precision) RETURNS double precision
    LANGUAGE "plpgsql" IMMUTABLE
    AS $$
BEGIN
    -- ST_Distance with geography type returns meters
    -- Multiply by 0.000621371 to convert to miles
    RETURN ST_Distance(
...
COMMENT ON FUNCTION "public"."calculate_distance_miles"("lat1" double precision, "lon1" double precision, "lat2" double precision, "lon2" double precision) IS 'Calculate great-circle distance between two points in miles using PostGIS';



CREATE OR REPLACE FUNCTION "public"."update_user_geopoint"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    IF NEW.latitude IS NOT NULL AND NEW.longitude IS NOT NULL THEN
        -- ST_SetSRID sets the Spatial Reference System ID (4326 = WGS84)
        -- ST_MakePoint creates a point from longitude, latitude (note: lon, lat order)
...
ALTER FUNCTION "public"."update_user_geopoint"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."user_can_manage_vehicle_image"("object_name" "text") RETURNS boolean
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    AS $$
DECLARE
  current_user_id uuid;
  vehicle_id text;
  vehicle_owner_supabase_id text;
  user_type text;
BEGIN
  -- Get current authenticated user's Supabase ID
  ...
  -- Extract vehicleId from path: vehicles/{vehicleId}/{filename}
  -- storage.foldername(name) returns array: ['vehicles', 'vehicleId', 'filename']
  -- We want index 2 (second folder level) which is the vehicleId
  vehicle_id := (storage.foldername(object_name))[2];
  
  IF vehicle_id IS NULL THEN
    RETURN false;
  END IF;
  
  -- Get the user's type and check if they're an admin
  SELECT u."userType" INTO user_type
  FROM public."User" u
  WHERE u."supabaseId" = current_user_id::text;
  ...
  SELECT u."supabaseId" INTO vehicle_owner_supabase_id
  FROM public."Vehicle" v
  JOIN public."User" u ON v."ownerId" = u.id
  WHERE v.id = vehicle_id;
  
  -- Return true if the user owns this vehicle
  RETURN vehicle_owner_supabase_id = current_user_id::text;
END;
$$;


ALTER FUNCTION "public"."user_can_manage_vehicle_image"("object_name" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."Deal" (
    ...
    "status" "public"."DealStatus" DEFAULT 'OPTIONS'::"public"."DealStatus" NOT NULL,
    "brief" "text",
    "date" "text",
    "fee" "text",
    "location" "text",
    ...
    "fullQuote" numeric(10,2),
    "spokeFee" numeric(10,2),
    "notes" "text",
    "dealType" "public"."DealType" DEFAULT 'PERSONAL_HIRE'::"public"."DealType" NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."DealRecipient" (
    "id" "text" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    ...
    "emailOpenedAt" timestamp(3) without time zone,
    "emailClickedAt" timestamp(3) without time zone,
    "errorMessage" "text",
    "status" "public"."RecipientStatus" DEFAULT 'PENDING'::"public"."RecipientStatus" NOT NULL
);


ALTER TABLE "public"."DealRecipient" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."DealVehicle" (
    "id" "text" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "dealId" "text" NOT NULL,
    ...
    "status" "public"."DealVehicleStatus" DEFAULT 'ACTIVE'::"public"."DealVehicleStatus" NOT NULL,
    "ownerRequestedFee" numeric(10,2)
);


ALTER TABLE "public"."DealVehicle" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."Media" (
    ...
    "duration" integer,
    "format" "text",
    "status" "public"."MediaStatus" DEFAULT 'READY'::"public"."MediaStatus" NOT NULL,
    "vehicleId" "text" NOT NULL,
    "order" integer DEFAULT 0 NOT NULL,
...
COMMENT ON COLUMN "public"."Media"."editMetadata" IS 'Stores crop area, zoom, and rotation state for image editor';
...
CREATE TABLE IF NOT EXISTS "public"."SteeringType" (
    "id" "text" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL,
    "name" "text" NOT NULL,
...
ALTER TABLE "public"."SteeringType" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."User" (
    ...
    "lastName" "text",
    "phone" "text",
    "userType" "public"."UserType" DEFAULT 'OWNER_ONLY'::"public"."UserType" NOT NULL,
    ...
    "geoUpdatedAt" timestamp(3) without time zone,
    "geoSource" "text",
    "company" "text",
    "termsAcceptedAt" timestamp(3) without time zone,
    "termsAcceptanceId" "text",
    "privacyPolicyAcceptedAt" timestamp(3) without time zone,
    "privacyAcceptanceId" "text"
);
...
COMMENT ON COLUMN "public"."User"."latitude" IS 'Latitude in decimal degrees (WGS84 coordinate system)';



COMMENT ON COLUMN "public"."User"."longitude" IS 'Longitude in decimal degrees (WGS84 coordinate system)';



COMMENT ON COLUMN "public"."User"."geoPoint" IS 'PostGIS Point geometry for spatial queries (SRID 4326 - WGS84)';



COMMENT ON COLUMN "public"."User"."geoUpdatedAt" IS 'Timestamp when geolocation was last updated';



COMMENT ON COLUMN "public"."User"."geoSource" IS 'Source of geolocation data (e.g., postcodes.io, manual)';
...
CREATE TABLE IF NOT EXISTS "public"."Vehicle" (
    ...
    "interiorColour" "text",
    "condition" "text",
    "isRoadLegal" boolean DEFAULT true NOT NULL,
    "price" numeric(10,2),
    "status" "public"."VehicleStatus" DEFAULT 'DRAFT'::"public"."VehicleStatus" NOT NULL,
    "description" "text",
...
CREATE TABLE IF NOT EXISTS "public"."VehicleCollection" (
    "id" "text" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "vehicleId" "text" NOT NULL,
...
ALTER TABLE "public"."VehicleCollection" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."VehicleSource" (
    "id" "text" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "vehicleId" "text" NOT NULL,
...
ALTER TABLE "public"."VehicleSource" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."VehicleSpecification" (
    "id" "text" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "vehicleId" "text" NOT NULL,
...
ALTER TABLE "public"."VehicleSpecification" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."DealRecipient"
    ADD CONSTRAINT "DealRecipient_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."DealVehicle"
    ADD CONSTRAINT "DealVehicle_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."SteeringType"
    ADD CONSTRAINT "SteeringType_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."VehicleCollection"
    ADD CONSTRAINT "VehicleCollection_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."VehicleSource"
    ADD CONSTRAINT "VehicleSource_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."VehicleSpecification"
    ADD CONSTRAINT "VehicleSpecification_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "Collection_isActive_idx" ON "public"."Collection" USING "btree" ("isActive");
...
CREATE INDEX "Collection_slug_idx" ON "public"."Collection" USING "btree" ("slug");
...
CREATE INDEX "DealRecipient_dealId_idx" ON "public"."DealRecipient" USING "btree" ("dealId");



CREATE UNIQUE INDEX "DealRecipient_dealId_userId_key" ON "public"."DealRecipient" USING "btree" ("dealId", "userId");



CREATE INDEX "DealRecipient_status_idx" ON "public"."DealRecipient" USING "btree" ("status");



CREATE INDEX "DealRecipient_userId_idx" ON "public"."DealRecipient" USING "btree" ("userId");



CREATE INDEX "DealVehicle_dealId_idx" ON "public"."DealVehicle" USING "btree" ("dealId");



CREATE UNIQUE INDEX "DealVehicle_dealId_vehicleId_key" ON "public"."DealVehicle" USING "btree" ("dealId", "vehicleId");



CREATE INDEX "DealVehicle_status_idx" ON "public"."DealVehicle" USING "btree" ("status");



CREATE INDEX "DealVehicle_vehicleId_idx" ON "public"."DealVehicle" USING "btree" ("vehicleId");



CREATE INDEX "Deal_clientContactId_idx" ON "public"."Deal" USING "btree" ("clientContactId");
...
CREATE INDEX "Deal_createdById_idx" ON "public"."Deal" USING "btree" ("createdById");
...
CREATE INDEX "Make_isActive_idx" ON "public"."Make" USING "btree" ("isActive");



CREATE INDEX "Make_isPublished_idx" ON "public"."Make" USING "btree" ("isPublished");



CREATE UNIQUE INDEX "Make_name_key" ON "public"."Make" USING "btree" ("name");



CREATE INDEX "Make_slug_idx" ON "public"."Make" USING "btree" ("slug");



CREATE UNIQUE INDEX "Make_slug_key" ON "public"."Make" USING "btree" ("slug");



CREATE INDEX "Media_isPrimary_idx" ON "public"."Media" USING "btree" ("isPrimary");



CREATE UNIQUE INDEX "Media_originalUrl_vehicleId_key" ON "public"."Media" USING "btree" ("originalUrl", "vehicleId");
...
CREATE INDEX "Media_vehicleId_isPrimary_status_idx" ON "public"."Media" USING "btree" ("vehicleId", "isPrimary", "status");



CREATE INDEX "Media_vehicleId_order_idx" ON "public"."Media" USING "btree" ("vehicleId", "order");



CREATE INDEX "Model_isActive_idx" ON "public"."Model" USING "btree" ("isActive");



CREATE INDEX "Model_isPublished_idx" ON "public"."Model" USING "btree" ("isPublished");



CREATE INDEX "Model_makeId_idx" ON "public"."Model" USING "btree" ("makeId");



CREATE UNIQUE INDEX "Model_makeId_slug_key" ON "public"."Model" USING "btree" ("makeId", "slug");



CREATE INDEX "Model_slug_idx" ON "public"."Model" USING "btree" ("slug");



CREATE INDEX "SteeringType_code_idx" ON "public"."SteeringType" USING "btree" ("code");



CREATE UNIQUE INDEX "SteeringType_code_key" ON "public"."SteeringType" USING "btree" ("code");



CREATE UNIQUE INDEX "SteeringType_name_key" ON "public"."SteeringType" USING "btree" ("name");



CREATE INDEX "User_company_idx" ON "public"."User" USING "btree" ("company");
...
CREATE INDEX "User_postcode_idx" ON "public"."User" USING "btree" ("postcode");
...
CREATE INDEX "User_supabaseId_idx" ON "public"."User" USING "btree" ("supabaseId");
...
CREATE INDEX "VehicleCollection_collectionId_idx" ON "public"."VehicleCollection" USING "btree" ("collectionId");



CREATE UNIQUE INDEX "VehicleCollection_vehicleId_collectionId_key" ON "public"."VehicleCollection" USING "btree" ("vehicleId", "collectionId");



CREATE INDEX "VehicleCollection_vehicleId_idx" ON "public"."VehicleCollection" USING "btree" ("vehicleId");



CREATE UNIQUE INDEX "VehicleSource_sourceType_sourceId_key" ON "public"."VehicleSource" USING "btree" ("sourceType", "sourceId");



CREATE INDEX "VehicleSource_vehicleId_idx" ON "public"."VehicleSource" USING "btree" ("vehicleId");



CREATE INDEX "VehicleSpecification_vehicleId_category_idx" ON "public"."VehicleSpecification" USING "btree" ("vehicleId", "category");



CREATE INDEX "Vehicle_engineCapacity_idx" ON "public"."Vehicle" USING "btree" ("engineCapacity");



CREATE INDEX "Vehicle_exteriorColour_idx" ON "public"."Vehicle" USING "btree" ("exteriorColour");



CREATE INDEX "Vehicle_interiorColour_idx" ON "public"."Vehicle" USING "btree" ("interiorColour");



CREATE INDEX "Vehicle_isRoadLegal_idx" ON "public"."Vehicle" USING "btree" ("isRoadLegal");



CREATE INDEX "Vehicle_makeId_idx" ON "public"."Vehicle" USING "btree" ("makeId");



CREATE INDEX "Vehicle_makeId_modelId_idx" ON "public"."Vehicle" USING "btree" ("makeId", "modelId");



CREATE INDEX "Vehicle_modelId_idx" ON "public"."Vehicle" USING "btree" ("modelId");



CREATE INDEX "Vehicle_numberOfSeats_idx" ON "public"."Vehicle" USING "btree" ("numberOfSeats");
...
CREATE INDEX "Vehicle_registration_idx" ON "public"."Vehicle" USING "btree" ("registration");
...
CREATE INDEX "Vehicle_status_makeId_idx" ON "public"."Vehicle" USING "btree" ("status", "makeId");



CREATE INDEX "Vehicle_status_price_idx" ON "public"."Vehicle" USING "btree" ("status", "price");



CREATE INDEX "Vehicle_status_year_idx" ON "public"."Vehicle" USING "btree" ("status", "year");



CREATE INDEX "Vehicle_year_idx" ON "public"."Vehicle" USING "btree" ("year");



CREATE INDEX "idx_user_search_name_email" ON "public"."User" USING "gin" ("to_tsvector"('"english"'::"regconfig", ((((COALESCE("firstName", ''::"text") || ' '::"text") || COALESCE("lastName", ''::"text")) || ' '::"text") || COALESCE("email", ''::"text"))));



CREATE INDEX "idx_user_search_phone" ON "public"."User" USING "gin" ("to_tsvector"('"english"'::"regconfig", COALESCE("phone", ''::"text")));



CREATE INDEX "idx_vehicle_search_description" ON "public"."Vehicle" USING "gin" ("to_tsvector"('"english"'::"regconfig", COALESCE("description", ''::"text")));



CREATE INDEX "idx_vehicle_search_name" ON "public"."Vehicle" USING "gin" ("to_tsvector"('"english"'::"regconfig", "name"));



CREATE INDEX "idx_vehicle_search_registration" ON "public"."Vehicle" USING "gin" ("to_tsvector"('"english"'::"regconfig", COALESCE("registration", ''::"text")));



CREATE OR REPLACE TRIGGER "user_geopoint_update" BEFORE INSERT OR UPDATE OF "latitude", "longitude" ON "public"."User" FOR EACH ROW EXECUTE FUNCTION "public"."update_user_geopoint"();



ALTER TABLE ONLY "public"."DealRecipient"
    ADD CONSTRAINT "DealRecipient_dealId_fkey" FOREIGN KEY ("dealId") REFERENCES "public"."Deal"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."DealRecipient"
    ADD CONSTRAINT "DealRecipient_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON UPDATE CASCADE ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."DealVehicle"
    ADD CONSTRAINT "DealVehicle_dealId_fkey" FOREIGN KEY ("dealId") REFERENCES "public"."Deal"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."DealVehicle"
    ADD CONSTRAINT "DealVehicle_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "public"."Vehicle"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Deal"
    ADD CONSTRAINT "Deal_clientContactId_fkey" FOREIGN KEY ("clientContactId") REFERENCES "public"."User"("id") ON UPDATE CASCADE ON DELETE SET NULL;



ALTER TABLE ONLY "public"."Deal"
    ADD CONSTRAINT "Deal_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "public"."User"("id") ON UPDATE CASCADE ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."Media"
    ADD CONSTRAINT "Media_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "public"."Vehicle"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Model"
    ADD CONSTRAINT "Model_makeId_fkey" FOREIGN KEY ("makeId") REFERENCES "public"."Make"("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."VehicleCollection"
    ADD CONSTRAINT "VehicleCollection_collectionId_fkey" FOREIGN KEY ("collectionId") REFERENCES "public"."Collection"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."VehicleCollection"
    ADD CONSTRAINT "VehicleCollection_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "public"."Vehicle"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."VehicleSource"
    ADD CONSTRAINT "VehicleSource_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "public"."Vehicle"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."VehicleSpecification"
    ADD CONSTRAINT "VehicleSpecification_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "public"."Vehicle"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Vehicle"
    ADD CONSTRAINT "Vehicle_makeId_fkey" FOREIGN KEY ("makeId") REFERENCES "public"."Make"("id") ON UPDATE CASCADE ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."Vehicle"
    ADD CONSTRAINT "Vehicle_modelId_fkey" FOREIGN KEY ("modelId") REFERENCES "public"."Model"("id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY "public"."Vehicle"
    ADD CONSTRAINT "Vehicle_steeringId_fkey" FOREIGN KEY ("steeringId") REFERENCES "public"."SteeringType"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE "public"."DealRecipient" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."DealVehicle" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."SteeringType" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."VehicleCollection" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."VehicleSource" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."VehicleSpecification" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."_prisma_migrations" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "service_role_only_collection" ON "public"."Collection" USING (false);



CREATE POLICY "service_role_only_country" ON "public"."Country" USING (false);



CREATE POLICY "service_role_only_make" ON "public"."Make" USING (false);



CREATE POLICY "service_role_only_media" ON "public"."Media" USING (false);



CREATE POLICY "service_role_only_model" ON "public"."Model" USING (false);



CREATE POLICY "service_role_only_source" ON "public"."VehicleSource" USING (false);



CREATE POLICY "service_role_only_spec" ON "public"."VehicleSpecification" USING (false);



CREATE POLICY "service_role_only_steering" ON "public"."SteeringType" USING (false);



CREATE POLICY "service_role_only_user" ON "public"."User" USING (false);



CREATE POLICY "service_role_only_vc" ON "public"."VehicleCollection" USING (false);



CREATE POLICY "service_role_only_vehicle" ON "public"."Vehicle" USING (false);
...
GRANT ALL ON FUNCTION "public"."calculate_distance_miles"("lat1" double precision, "lon1" double precision, "lat2" double precision, "lon2" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_distance_miles"("lat1" double precision, "lon1" double precision, "lat2" double precision, "lon2" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_distance_miles"("lat1" double precision, "lon1" double precision, "lat2" double precision, "lon2" double precision) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_user_geopoint"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_user_geopoint"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_user_geopoint"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_can_manage_vehicle_image"("object_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."user_can_manage_vehicle_image"("object_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."user_can_manage_vehicle_image"("object_name" "text") TO "service_role";
...
GRANT ALL ON TABLE "public"."DealRecipient" TO "anon";
GRANT ALL ON TABLE "public"."DealRecipient" TO "authenticated";
GRANT ALL ON TABLE "public"."DealRecipient" TO "service_role";
 



GRANT ALL ON TABLE "public"."DealVehicle" TO "anon";
GRANT ALL ON TABLE "public"."DealVehicle" TO "authenticated";
GRANT ALL ON TABLE "public"."DealVehicle" TO "service_role";
...
GRANT ALL ON TABLE "public"."SteeringType" TO "anon";
GRANT ALL ON TABLE "public"."SteeringType" TO "authenticated";
GRANT ALL ON TABLE "public"."SteeringType" TO "service_role";
...
GRANT ALL ON TABLE "public"."VehicleCollection" TO "anon";
GRANT ALL ON TABLE "public"."VehicleCollection" TO "authenticated";
GRANT ALL ON TABLE "public"."VehicleCollection" TO "service_role";
 



GRANT ALL ON TABLE "public"."VehicleSource" TO "anon";
GRANT ALL ON TABLE "public"."VehicleSource" TO "authenticated";
GRANT ALL ON TABLE "public"."VehicleSource" TO "service_role";
 



GRANT ALL ON TABLE "public"."VehicleSpecification" TO "anon";
GRANT ALL ON TABLE "public"."VehicleSpecification" TO "authenticated";
GRANT ALL ON TABLE "public"."VehicleSpecification" TO "service_role";
