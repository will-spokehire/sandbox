...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "payload"."enum_static_pages_blocks_spacer_height" AS ENUM('small', 'medium', 'large', 'extra-large');
  ...
  CREATE TYPE "payload"."enum_static_blocks_blocks_spacer_height" AS ENUM('small', 'medium', 'large', 'extra-large');
  ...
  CREATE TABLE "payload"."static_pages_blocks_stats_bar" (
  	...
  	"columns" "payload"."enum_static_pages_blocks_stats_bar_columns" DEFAULT '4',
  	"background_color" "payload"."enum_static_pages_blocks_stats_bar_background_color" DEFAULT 'default',
  ...
  CREATE TABLE "payload"."static_blocks_blocks_stats_bar" (
  	...
  	"columns" "payload"."enum_static_blocks_blocks_stats_bar_columns" DEFAULT '4',
  	"background_color" "payload"."enum_static_blocks_blocks_stats_bar_background_color" DEFAULT 'default',
  	"hide_on_mobile" boolean DEFAULT false,
  	"block_name" varchar
  );
