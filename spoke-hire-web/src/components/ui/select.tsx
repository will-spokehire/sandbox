  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // Placeholder
        "data-[placeholder]:text-spoke-black/40",
        // Focus state
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "bg-spoke-white text-spoke-black border border-spoke-black",
          // Animations
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-muted-foreground px-2 py-1.5 body-xs", className)}
      {...props}
    />
  )
}
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // Hover/Focus states
        "outline-none hover:bg-spoke-black/5 focus:bg-spoke-black/5",
        // Disabled state
