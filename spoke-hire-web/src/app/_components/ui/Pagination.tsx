...
export function Pagination({
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-3 py-2 sm:px-4">
          ...
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {getVisiblePages().map((page, index) => (
              <button
                ...
                disabled={page === "..."}
                className={`
                  relative inline-flex items-center px-2 py-1.5 text-xs font-semibold
                  ${page === currentPage + 1
