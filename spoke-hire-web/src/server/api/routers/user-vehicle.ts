...
const updateMyVehicleInputSchema = z.object({
  ...
  dailyRate: z.number().min(0, "Daily rate must be a positive number").optional(),
  year: z.string().optional(),
  registration: z.string().min(1, "Registration is required").optional(),
  makeId: z.string().optional(),
  modelId: z.string().optional(),
  engineCapacity: z.number().min(1, "Engine capacity must be greater than 0").optional(),
  numberOfSeats: z.number().min(1).max(20).optional(),
  steeringId: z.string().min(1, "Steering type is required").optional(),
  gearbox: z.string().min(1, "Gearbox is required").optional(),
  exteriorColour: z.string().min(1, "Exterior colour is required").optional(),
  interiorColour: z.string().min(1, "Interior colour is required").optional(),
